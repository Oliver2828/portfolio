    ...
    <footer className="bg-gray-800 py-5 text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex justify-center space-x-6 mb-8">
          <a
            href="https://www.linkedin.com/in/ezenwaka-oliver-906ab9234?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
            target="_blank"
          ...
          <a
            href="https://github.com/Oliver2828?tab=repositories"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://x.com/etochukwu9/status/1678664728082538496?s=46"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="mt-8 text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Ezenwaka Tochukwu Oliver. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
