    ...
    <section id="about" className="py-20 bg-gray-100 text-gray-800">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-5 md:px-0">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          ...
          <p className="text-lg">
            Hi, I'm <strong>Ezenwaka Tochukwu Oliver</strong>, a passionate Full Stack Developer. I specialize in building scalable and dynamic web applications using modern frameworks and technologies. With years of experience, I enjoy solving complex problems and constantly learning new skills.
          </p>
          <p className="text-lg">
